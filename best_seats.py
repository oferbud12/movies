...
class BestSeats(UserType):
    ...
    def get_best_line_for_theater_measures(self):
        ...
        best_line = math.ceil(self.type_height_ratio * max_fake_line)
        return best_line

    def validate_best_line_for_theater_measures(self, best_line):
        ...
        if best_line not in self.fake_optional_lines.keys():
            for i in range(1, self.max_movement_for_ideal_best_line + 1):
    ...
    def get_best_seats_for_theater_measures(self):
        # (Always comparing to the fake_optional_lines - the real theater space should be our reference)
        ...
        best_seat_in_line = int(math.ceil(seats_in_horizontal_length_reference[-1] * self.type_horizontal_ratio))
    ...
    def validate_optional_best_seats(self, optional_best_seats, optional_best_line):
        # (Always comparing to the fake_optional_lines - the real theater space should be our reference)
        ...
        if optional_best_seats_are_valid is not True:
            max_movement_in_line = self.gush_ends[0][1] - optional_best_seats[-1]
    ...
    def find_best_seats(self):
        ...
        if validation_of_ideal_best_seats[0] is False:
            for i in range(1, self.max_movement_between_lines + 1):
                if i % 2 != 0:
            ...
            raise Exception("Moved too much and couldn't fit in, abort.")
        else:
...
if __name__ == "__main__":
    ...
    movie_seats = {1: {'line_offset': 0, 'seats': {1: {'state': '0', 'offset': 0}, 2: {'state': '0', 'offset': 0}, 3: {'state': '0', 'offset': 0}, 4: {'state': '0', 'offset': 0}, 5: {'state': '0', 'offset': 0}, 6: {'state': '0', 'offset': 0}, 7: {'state': '0', 'offset': 0}, 8: {'state': '0', 'offset': 0}, 9: {'state': '0', 'offset': 0}, 10: {'state': '0', 'offset': 0}, 11: {'state': '0', 'offset': 0}, 12: {'state': '0', 'offset': 0}, 13: {'state': '0', 'offset': 1}, 14: {'state': '0', 'offset': 1}, 15: {'state': '0', 'offset': 1}, 16: {'state': '0', 'offset': 1}}}, 2: {'line_offset': 0, 'seats': {1: {'state': '0', 'offset': 0}, 2: {'state': '0', 'offset': 0}, 3: {'state': '0', 'offset': 0}, 4: {'state': '0', 'offset': 0}, 5: {'state': '0', 'offset': 0}, 6: {'state': '0', 'offset': 0}, 7: {'state': '0', 'offset': 0}, 8: {'state': '0', 'offset': 0}, 9: {'state': '0', 'offset': 0}, 10: {'state': '0', 'offset': 0}, 11: {'state': '0', 'offset': 0}, 12: {'state': '0', 'offset': 0}, 13: {'state': '0', 'offset': 1}, 14: {'state': '0', 'offset': 1}, 15: {'state': '0', 'offset': 1}, 16: {'state': '0', 'offset': 1}}}, 3: {'line_offset': 0, 'seats': {1: {'state': '0', 'offset': 0}, 2: {'state': '0', 'offset': 0}, 3: {'state': '0', 'offset': 0}, 4: {'state': '0', 'offset': 0}, 5: {'state': '0', 'offset': 0}, 6: {'state': '0', 'offset': 0}, 7: {'state': '0', 'offset': 0}, 8: {'state': '0', 'offset': 0}, 9: {'state': '0', 'offset': 0}, 10: {'state': '0', 'offset': 0}, 11: {'state': '0', 'offset': 0}, 12: {'state': '0', 'offset': 0}, 13: {'state': '0', 'offset': 1}, 14: {'state': '0', 'offset': 1}, 15: {'state': '0', 'offset': 1}, 16: {'state': '0', 'offset': 1}}}, 4: {'line_offset': 0, 'seats': {1: {'state': '0', 'offset': 1}, 2: {'state': '0', 'offset': 1}, 3: {'state': '0', 'offset': 1}, 4: {'state': '0', 'offset': 1}, 5: {'state': '0', 'offset': 1}, 6: {'state': '0', 'offset': 1}, 7: {'state': '0', 'offset': 1}, 8: {'state': '0', 'offset': 1}, 9: {'state': '0', 'offset': 1}, 10: {'state': '0', 'offset': 1}, 11: {'state': '0', 'offset': 1}, 12: {'state': '0', 'offset': 2}, 13: {'state': '0', 'offset': 2}, 14: {'state': '0', 'offset': 2}, 15: {'state': '0', 'offset': 2}}}, 5: {'line_offset': 0, 'seats': {1: {'state': '0', 'offset': 1}, 2: {'state': '0', 'offset': 1}, 3: {'state': '0', 'offset': 1}, 4: {'state': '0', 'offset': 1}, 5: {'state': '0', 'offset': 1}, 6: {'state': '0', 'offset': 1}, 7: {'state': '0', 'offset': 1}, 8: {'state': '0', 'offset': 1}, 9: {'state': '0', 'offset': 1}, 10: {'state': '0', 'offset': 1}, 11: {'state': '0', 'offset': 1}, 12: {'state': '0', 'offset': 2}, 13: {'state': '0', 'offset': 2}, 14: {'state': '0', 'offset': 2}, 15: {'state': '0', 'offset': 2}}}, 6: {'line_offset': 0, 'seats': {1: {'state': '0', 'offset': 1}, 2: {'state': '0', 'offset': 1}, 3: {'state': '0', 'offset': 1}, 4: {'state': '0', 'offset': 1}, 5: {'state': '0', 'offset': 1}, 6: {'state': '0', 'offset': 1}, 7: {'state': '0', 'offset': 1}, 8: {'state': '0', 'offset': 1}, 9: {'state': '0', 'offset': 1}, 10: {'state': '0', 'offset': 1}, 11: {'state': '0', 'offset': 1}, 12: {'state': '0', 'offset': 2}, 13: {'state': '0', 'offset': 2}, 14: {'state': '0', 'offset': 2}, 15: {'state': '0', 'offset': 2}}}, 7: {'line_offset': 0, 'seats': {1: {'state': '0', 'offset': 1}, 2: {'state': '0', 'offset': 1}, 3: {'state': '0', 'offset': 1}, 4: {'state': '0', 'offset': 1}, 5: {'state': '0', 'offset': 1}, 6: {'state': '0', 'offset': 1}, 7: {'state': '0', 'offset': 1}, 8: {'state': '0', 'offset': 1}, 9: {'state': '0', 'offset': 1}, 10: {'state': '0', 'offset': 1}, 11: {'state': '0', 'offset': 1}, 12: {'state': '0', 'offset': 2}, 13: {'state': '0', 'offset': 2}, 14: {'state': '0', 'offset': 2}, 15: {'state': '0', 'offset': 2}}}, 8: {'line_offset': 0, 'seats': {1: {'state': '0', 'offset': 1}, 2: {'state': '0', 'offset': 1}, 3: {'state': '0', 'offset': 1}, 4: {'state': '0', 'offset': 1}, 5: {'state': '0', 'offset': 1}, 6: {'state': '0', 'offset': 1}, 7: {'state': '0', 'offset': 1}, 8: {'state': '0', 'offset': 1}, 9: {'state': '0', 'offset': 1}, 10: {'state': '0', 'offset': 1}, 11: {'state': '0', 'offset': 1}, 12: {'state': '0', 'offset': 2}, 13: {'state': '0', 'offset': 2}, 14: {'state': '0', 'offset': 2}, 15: {'state': '0', 'offset': 2}}}, 9: {'line_offset': 0, 'seats': {1: {'state': '0', 'offset': 2}, 2: {'state': '0', 'offset': 2}, 3: {'state': '0', 'offset': 2}, 4: {'state': '0', 'offset': 2}, 5: {'state': '0', 'offset': 2}, 6: {'state': '0', 'offset': 2}, 7: {'state': '0', 'offset': 2}, 8: {'state': '0', 'offset': 2}, 9: {'state': '0', 'offset': 2}, 10: {'state': '0', 'offset': 2}, 11: {'state': '0', 'offset': 4}, 12: {'state': '0', 'offset': 4}, 13: {'state': '0', 'offset': 4}}}}
    movie_tickets = 3
    check = BestSeats(9, movie_seats, movie_tickets)
    ...
    # fix max_movement_between_lines
